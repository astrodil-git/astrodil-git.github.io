...
const PROJECTS = [
  ...
  },
  {
    ...
    media: { type: "video", src: "assets/media/newsletter.mp4", alt: "Generated market newsletter" },
  ...
  },
  {
    ...
    media: { type: "image", src: "assets/img/earnings-calendar.png", alt: "Company data surfaced from SEC filings" },
    links: []
  },
  {
  ...
  },
  {
    ...
    scale: "7 merged PRs",
    blurb:
      "Making the platform legible to machines as well as people. An llms.txt route gives AI crawlers a structured description of what viaNexus is, what it sells and where its canonical pages live, backed by a robots.txt tuned for the same audience and a sweep of the Search Console 404s that were bleeding link equity.",
    details: [
      "llms.txt route describing products, principles and canonical pages",
    ...
    media: { type: "image", src: "assets/img/llms-txt.png", alt: "The llms.txt route served at vianexus.com" },
    links: [{ label: "llms.txt", href: "https://vianexus.com/llms.txt" }]
  },
