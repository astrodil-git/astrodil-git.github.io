...
const PROJECTS = [
  ...
  },
  {
    ...
    details: [
      ...
      "Seven categories mapped from item codes: earnings, officer changes, M&A, meetings, IR, other events, exhibits",
      "FastAPI layer serving stats, agent status and filings filterable by symbol and category",
      "A web dashboard over the classified set, served by the agent itself",
      "/health reports progress rather than liveness — 503 when ingestion stalls while the process is up",
    ],
